...
//    handler_->OnStatistics(instrument_.securityid, statistics_);
  ...
  void InstrumentMdHandler::OnChannelReset() {
    ...
    channelcontext->NotifyBookRefresh(instrument_.securityid, implbook_);
  }
  ...
  InstrumentMdHandler::InstrumentMdHandler(Instrument instrument, ChannelContext* channelcontext)
